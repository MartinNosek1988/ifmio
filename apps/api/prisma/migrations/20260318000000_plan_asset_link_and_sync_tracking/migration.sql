...
ALTER TABLE "revision_subjects" ADD COLUMN "assetId" UUID;
...
ALTER TABLE "revision_plans" ADD COLUMN "assetId"               UUID;
ALTER TABLE "revision_plans" ADD COLUMN "assetTypeAssignmentId" UUID;
